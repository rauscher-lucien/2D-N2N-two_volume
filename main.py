...
def main():
    ...
    if os.getenv('RUNNING_ON_SERVER') == 'true':
        ...
        project_dir = os.path.join('/g', 'prevedel', 'members', 'Rauscher', 'final_projects', '2D-N2N-two_volume')
        ...
        train_data_dir = r"\\tier2.embl.de\prevedel\members\Rauscher\data\two_volume-noisy_clean-nema"
        val_data_dir = r"\\tier2.embl.de\prevedel\members\Rauscher\data\two_volume-noisy_clean-nema"
        project_dir = r"C:\Users\rausc\Documents\EMBL\final_projects\2D-N2N-two_volume"
        project_name = 'test_x'
        train_continue = 'off'
        disp_freq = 1
        val_freq = 1
